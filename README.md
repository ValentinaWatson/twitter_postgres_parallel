...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/ValentinaWatson/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/ValentinaWatson/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/ValentinaWatson/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/ValentinaWatson/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/ValentinaWatson/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/ValentinaWatson/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7m57.247s                 | 1m06.929s                 | 
| `pg_normalized_batch`  | 3m01.539s                 | 0m15.462s                 | 
| `pg_denormalized`      | 0m17.947s                 | 0m04.839s                 | 
